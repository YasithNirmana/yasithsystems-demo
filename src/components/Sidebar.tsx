...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`flex flex-col h-screen bg-slate-900 border-r border-white/5 transition-all duration-300 flex-shrink-0 ${
        collapsed ? "w-16" : "w-60"
      }`}
    >
      {/* Logo */}
      <div className="h-16 flex items-center px-4 border-b border-white/5 gap-3">
        ...
        {!collapsed && (
          <div className="overflow-hidden">
            <p className="text-white font-semibold text-sm leading-tight">YasithSystems</p>
            <p className="text-slate-500 text-xs">Property Dashboard</p>
          </div>
        )}
      </div>
      ...
      <div className="px-2 pb-4">
        ...
        >
          <svg className={`w-5 h-5 flex-shrink-0 transition-transform ${collapsed ? "rotate-180" : ""}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M11.25 9l-3 3m0 0l3 3m-3-3h7.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
